...
\begin{minipage}[b]{0.4\linewidth}
    \vspace{0.5cm}
The robust method developed in \cite{forster_improving_2025} is only valid for cases 1,2. We wish to learn the parameters $\hat{\theta}$ that provide the ``best'' model of our true process. We aim to pick a experiments so that we ``optimally'' obtain data from which to infer our model parameters. 
